...
import { getSpecificSubcategoryData } from "../../APIs Connections/Admin/Subcategories/getSpecificSubcategoryData";
import { updateSubcategory } from "../../APIs Connections/Admin/Subcategories/updateSubcategory";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const subCategoryData = await getSpecificSubcategoryData(id);
